...
def test2(inverted_index):
    ...
    print('Top-k result = ', topk_result) # [(6,3), (6,7)]
    print('Evaluation Count = ', full_evaluation_count)# 4

def test3(inverted_index):
    ## Test cases
    ...
    print('Top-k result = ', topk_result) # [(12,1), (10,3), (10,9)]
    print('Evaluation Count = ', full_evaluation_count) #15
...
def test5():
    documents = {1: 'to be or not to be that is the question', 2: 'to be a programmer means you do not eat or sleep, not leave your desk or beep or peep or bleep, you can only weep or sweep or use a heap'}
    inverted_index = InvertedIndex(documents).get_inverted_index()
...
#test6(inverted_index)
test7(inverted_index)